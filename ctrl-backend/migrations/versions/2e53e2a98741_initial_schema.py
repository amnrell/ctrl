...
Revision ID: 2e53e2a98741
Revises: 
Create Date: 2025-12-11 00:26:12.535703
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_mood_entries_mood'), 'mood_entries', ['mood'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_mood_entries_mood'), table_name='mood_entries')
